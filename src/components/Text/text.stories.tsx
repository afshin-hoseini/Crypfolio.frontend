...
type Props = TextProps & {children?: any, TextComponent?: ComponentType}
...
const Template : Story<Props> = (args: Props)=> {
    ...
    const txtCmpArgs = {...args};
    delete txtCmpArgs["type"];

    return (
        <>
            <p>Using  <code>Text</code> component</p>
            <Text {...rawArgs}/>
            
            <p>Using <code>{args.TextComponent?.displayName}</code> component</p>
