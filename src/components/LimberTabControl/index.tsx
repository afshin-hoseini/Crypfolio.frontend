...
export const LimberTabControl: FC<props> = ({ items, selectedId, className, onSelect }) => {
  ...
  return (
    <LimberTabControlItemsContainerWrapper ref={menuContainerRef} className={`${className}`}>
